<template>
  ...
  >
    <div class="flex flex-col items-center mb-12">
      <h1 class="text-2xl sm:text-4xl md:text-6xl font-bold text-center mb-6 md:mb-16"><br />
        realtime 游乐场
      </h1>
      <PlayButton />
    </div>
...
const listen = () =>
   ...
   supabase.channel('public:realtime_user')
      .on('postgres_changes', { event: '*', schema: 'public', table: 'realtime_user' }, (payload) => {
